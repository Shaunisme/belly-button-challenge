...
2. Create a horizontal bar chart with a dropdown menu to display the top 10 OTUs found in that individual.
  ...
  * Use `otu_labels` as the hover text for the chart.
  ...
  ![bar Chart](https://i.ibb.co/6PmV746/barchart.png)
...
![Bubble Chart](https://i.ibb.co/mB9V14b/bubble.png)

4. Display the sample metadata, i.e., an individual's demographic information.

5. Display each key-value pair from the metadata JSON object somewhere on the page.

![hw](https://i.ibb.co/fFShdJD/option.png)
...
![hw](https://i.ibb.co/CwvVLQ1/whole.png)
...
![Weekly Washing Frequency Gauge](https://i.ibb.co/rfhYSph/gauge.png)
